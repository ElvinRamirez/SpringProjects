...
<body>
	<div>
		<h1>Add to <c:out value="${songs.title}"></c:out></h1>
		<div>
			<form:form action="/song/${songs.id}" modelAttribute="songs" class="form" method="post">
		...
		<div class="d-flex flex-row bd-highlight">
			...
			<form action="/songs/${songs.id}/delete" method="POST">
